...
shinyServer(function(input, output) {
        ...
        output$source_patent<-renderText(input$source_patent)
    
        url <- renderText(input$website)
        ...
        output$table<-p_output
        
        output$download <- downloadHandler(filename = "data.csv",
        content = write.csv(p_output,"output.csv")
        )
